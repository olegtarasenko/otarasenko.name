...
<p>At the moment, this is the first written by me website without use of any CMS-engines, themes and plugins. 
It is very simple, without use of special "tricks" and if you look, the newcomer will not make much effort to create something similar, if not better.
So, for the basis I took stylesheet package <a href="http://getbootstrap.com/">Bootstrap</a>, first of all because it has a large amount of ready-made solutions that help to save time, effort and nerves. 
Second and one of the key as for me and because of what I actually use it, the presence of rules for the correct display of the webpages on mobile devices.<br><br>
I should also mention a large number of sites, guides for web design, I personally liked <a href="http://stackoverflow.com/">stackoverflow</a> – site type question and answer, but you can also use <a href="http://bootsnipp.com/">bootsnipp</a> as well.<br><br>
...
<a href="http://www.cssmatic.com/">cssmatic</a> – can be used to create a gradient (I don't have one)
...
I hope that I didn’t forget anyone.</p>
	...
	<div class="trian">
	<object type="image/svg+xml" data="triangles.svg">
	</object>
	</div>
<div class="border">
		<div class="container">
...
<g>
	...
	<polygon fill="#81B2B2" points="129.229,34.437 98.508,17.987 82.427,30.598 	"/>
           ...
           <div style="font-size:13; padding-top:15px">Feel free to copy &copy 2015</div>
    </div>
</body>
</html>